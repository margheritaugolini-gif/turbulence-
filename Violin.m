% PURPOSE:
% Plotting utility class used by the analysis scripts.
% Creates violin plots with optional data points, means, medians, and
% styling controls; it does not run an analysis by itself.
